...
def post_comment(request, next=None, using=None):
    ...
    return render_list(request, ctype, object_pk)


def render_list(request, content_type, object_pk):
    """Wrap render_comment_list tag in view."""
    ...
    context = RequestContext(request, {'object': obj})
